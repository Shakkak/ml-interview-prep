...
**Stick-breaking construction:** $\beta_k \sim \text{Beta}(1, \alpha_0)$, $\pi_k = \beta_k \prod_{j<k}(1 - \beta_j)$, $\theta_k \sim H$. As $\alpha_0 \to 0$, a single component dominates; as $\alpha_0 \to \infty$, components become equiprobable.
...
*See also: [[bayesian-inference]] · [[distributions-overview]] · [[exponential-family]] · [[gaussian-mixture-models]] · [[variational-inference]]*
